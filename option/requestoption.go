...
// RequestOption is an option for the requests made by the bookstore-2 API Client
// which can be supplied to clients, services, and methods. You can read more about this functional
// options pattern in our [README].
//
// [README]: https://pkg.go.dev/github.com/nguyenhoaibao/stainless-bookstore-demo-go#readme-requestoptions
...
func WithEnvironmentProduction() RequestOption {
	return WithBaseURL("http://example.com/api/v1/")
}
...
func WithEnvironmentEnvironment1() RequestOption {
	return WithBaseURL("https://example.com/api/v1/")
}
