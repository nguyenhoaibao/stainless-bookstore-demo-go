...
// interacting with the bookstore-2 API. You should not instantiate this client
...
// environment (API_KEY, BASIC_AUTH_USERNAME, BASIC_AUTH_PASSWORD). The option
...
func (r *Client) Echo(ctx context.Context, body EchoParams, opts ...option.RequestOption) (res *string, err error) {
	opts = append(r.Options[:], opts...)
	path := "echo"
