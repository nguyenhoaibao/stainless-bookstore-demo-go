...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Echo(context.Background(), bookstore2.EchoParams{
		Body: "Hello world!",
	})
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Echo(cancelCtx, bookstore2.EchoParams{
		Body: "Hello world!",
	})
	if err == nil {
		t.Error("Expected there to be a cancel error")
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Echo(deadlineCtx, bookstore2.EchoParams{
			Body: "Hello world!",
		})
		if err == nil {
