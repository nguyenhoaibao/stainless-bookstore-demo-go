...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Echo(context.Background(), bookstore2.EchoParams{
		Body: "Hello world!",
	})
	if userAgent != fmt.Sprintf("Bookstore2/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	res, err := client.Echo(context.Background(), bookstore2.EchoParams{
		Body: "Hello world!",
	})
	if err == nil || res != nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.Echo(cancelCtx, bookstore2.EchoParams{
		Body: "Hello world!",
	})
	if err == nil || res != nil {
		t.Error("Expected there to be a cancel error and for the response to be nil")
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.Echo(deadlineCtx, bookstore2.EchoParams{
			Body: "Hello world!",
		})
		if err == nil || res != nil {
